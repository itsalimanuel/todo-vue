...
<template>
  <div
    class="font-black drop-shadow-xl fixed top-0 left-0 overflow-hidden z-30 bg-blue-800 max-2xl:w-1/3 max-xl:w-1/2 max-md:w-1/2 max-sm:w-full lg:h-screen rounded-r-lg"
  >
    <div
